...
RocketChat.settings.addGroup 'Layout', ->
	...
	@section 'Content', ->
		...
		@add 'Layout_Home_Body', '欢迎来到咕嚕创客', { type: 'code', code: 'text/html', multiline: true, public: true }
		...
		@add 'Layout_Login_Terms', '©2017  京ICP备17041304号 |', { type: 'string', multiline: true, public: true }
		...
		@add 'Layout_Sidenav_Footer', '<img style="left: 10px; position: absolute;" width="100%" height="73px;" src="/assets/logo.png" />', { type: 'code', code: 'text/html', public: true, i18nDescription: 'Layout_Sidenav_Footer_description' }
