...
Pinyin.GetQP=function(l1){ 
    var l2 = l1.length; 
    var I1 = ""; 
   // var reg = new RegExp('[a-zA-Z0-9\- ]'); //¿Õ¸ñ×ª»»³É-
    var reg = new RegExp('[a-zA-Z0-9\]');  //È¥µô¿Õ¸ñ
    for (var i=0;i<l2;i++) { 
...
/*
 * Èç¹ûÊÇÁ½¸öºº×ÖÔòÖ±½ÓÊäÈëºº×ÖµÄÈ«Æ´
 * Èç¹ûÊÇÈý¸öÒÔÉÏµÄºº×Ö£¬µÚÒ»¸öºº×ÖÈ«Æ´£¬ºóÃæµÄºº×Ö¼òÂë
 */
